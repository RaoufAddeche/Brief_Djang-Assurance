...
urlpatterns = [
    ...
    path(
        "unicorn/prediction/result/update/<int:pk>/",
        PredictionUpdateView.as_view(),
        name="prediction_update",
    ),
    path(
        "unicorn/prediction/result/delete/<int:pk>/",
        PredictionDeleteView.as_view(),
    ...
    path(
        "prediction/result/update/<int:pk>/",
        UserPredictionUpdateView.as_view(),
        name="user_update",
    ),
]
